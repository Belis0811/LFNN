...
def _make_ntuple(value: Any, n: int) -> Tuple[Any, ...]:
    """Return ``value`` as an n-tuple, matching torchvision's helper."""
...
def test():
    net = ViT(num_classes=1000, image_size=256, patch_size=16, hidden_dim=768, num_heads=12, num_layers=12, mlp_dim=3072)
    y,x1,x2,x3 = net(torch.randn(1, 3, 256, 256))
    print(y.size())
    print(x1.size())
    print(x2.size())
    print(x3.size())
